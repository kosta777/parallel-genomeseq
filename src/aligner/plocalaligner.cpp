...
std::vector<std::pair<size_t, size_t>> _make_string_range(int npiece, size_t shortstringlength ,size_t longstringlength, float overlap_ratio) {
  ...
  while ((float)(longstringlength - right + overlaplength) > piecelength ) {
