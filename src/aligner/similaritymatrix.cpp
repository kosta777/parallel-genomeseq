...
Similarity_Matrix::Similarity_Matrix(std::string_view sequence_x, std::string_view sequence_y) : raw_matrix(sequence_x.size() + 1, sequence_y.size() + 1),
...
void Similarity_Matrix::iterate_column(const std::function<float(const char &, const char &)> &scoring_function, float gap_penalty) {
...
void Similarity_Matrix::iterate(const std::function<float(const char &, const char &)> &scoring_function, float gap_penalty) {
...
Similarity_Matrix_Skewed::Similarity_Matrix_Skewed(std::string_view _sequence_x, std::string_view _sequence_y) : sequence_x(_sequence_y.size() + N_PACK),
...
void Similarity_Matrix_Skewed::iterate(const std::function<float(const char &, const char &)> &scoring_function, float gap_penalty) {
